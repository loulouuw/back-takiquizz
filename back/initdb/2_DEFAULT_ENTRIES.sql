...
(1, 'What is the capital of France?', 'Paris', ARRAY['London', 'Berlin', 'Madrid'], 'multiple_choice', NULL, 30, 1),
(2, 'Who developed the theory of relativity?', 'Albert Einstein', ARRAY['Isaac Newton', 'Galileo Galilei', 'Nikola Tesla'], 'multiple_choice', NULL, 45, 2),
(3, 'Which planet is known as the Red Planet?', 'Mars', ARRAY['Earth', 'Jupiter', 'Venus'], 'multiple_choice', NULL, 30, 1),
(4, 'What is the chemical symbol for water?', 'H2O', ARRAY['O2', 'CO2', 'H2'], 'multiple_choice', NULL, 45, 2);
